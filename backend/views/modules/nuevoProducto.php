        ...
        <div class="row">
            <div class="col-md-8 order-md-1">
                <form class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="capellada">Pesos</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="forro">Dólares</label>
                            <input type="text" class="form-control" id="forro" placeholder="forro" value="">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <input type="checkbox" class="custom-control-input" id="showStock">
                            <label class="custom-control-label" for="showStock">Visible solo mientras haya
                                stock</label>
                        </div>
                        <div class="col-md-6 mb-3">
